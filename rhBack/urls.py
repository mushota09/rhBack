"""
URL configuration for rhBack project
"""
...
# Create main ADRF router and extend with app routers
...
urlpatterns = [
    ...
    # API Routes - unified router
    path('api/', include(router.urls)),
    # Individual app routes for non-router endpoints
